...
public class UC4_EmpWageOOPS {
	...
	public UC4_EmpWageOOPS() {        	// Making constructor which helps to not create object again and again
	...
	public static void main(String []args) {
		...
		UC4_EmpWageOOPS UC4 = new UC4_EmpWageOOPS();		//object created
