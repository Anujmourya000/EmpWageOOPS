...
public class UC6_EmpWageOOPS {
	...
	public UC6_EmpWageOOPS() {        	// Making constructor which helps to not create object again and again
	...
	public static void main(String []args) {
		...
		UC6_EmpWageOOPS UC6 = new UC6_EmpWageOOPS();		//object created
